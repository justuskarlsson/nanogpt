## ALSO Super unstable 125: 5.9, 376: 7.6 val loss (1 gpu)
# Could be learning rate? fewer gpus and shorter seq len..
...
class Hyperparameters:
    ...
    val_seq_len = 2 * 32 * 1024  # FlexAttention sequence length for validation
    # optimization
